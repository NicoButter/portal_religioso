  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-4 text-black">Reflexiones</h1>
        <ul className="space-y-6">
          {reflexiones.map((ref, idx) => (
            <li key={idx} className="bg-white p-4 rounded shadow">
              <h2 className="text-lg font-semibold text-black mb-2">{ref.title}</h2>
              <p className="text-black">{ref.text}</p>
            </li>
          ))}
        </ul>
      </main>
