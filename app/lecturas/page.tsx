  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-4 text-gray-800">Lecturas</h1>
        <p className="mb-6 text-gray-600">Material espiritual creado por el editor de la web, Fabián Cavero.</p>
        <ul className="space-y-6">
          {lecturas.map((lectura, idx) => (
            <li key={idx} className="bg-white p-4 rounded shadow">
              <h2 className="text-lg font-semibold text-blue-700 mb-1">{lectura.title}</h2>
